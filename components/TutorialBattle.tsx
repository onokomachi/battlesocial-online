...
const STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    highlight: 'problem',
    question: '織田信長が室町幕府15代将軍・足利義昭を追放したのは（　）年である。',
    answer: '1573',
    hint: '室町幕府が滅んだ年です。信長包囲網を打ち破った後の出来事です。',
  },
  {
    title: '正解！ダメージを与えた！',
  ...
  },
  {
    ...
    highlight: 'problem',
    question: '豊臣秀吉が1588年に行った、農民から刀や武器を取り上げた政策を何というか。',
    answer: '刀狩',
    hint: '兵農分離を進めた政策のひとつです。「刀狩令」ともいいます。',
  },
  {
    title: 'チュートリアル完了！',
